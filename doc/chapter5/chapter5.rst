...
我们F407骄阳开发板中使用的芯片是176pin的STM32F407IGT6，具体见 图5_1_。
这个就是我们接下来要学习的STM32，它将带领我们进入嵌入式的殿堂。

芯片正面是丝印，ARM应该是表示该芯片使用的是ARM的内核，STM32F407IGT6是芯片型号，后面的字应该是跟生产批次相关，最下面的是ST的LOGO。
...
图 5‑1 STM32F407IGT6 实物图(图中方框部分的芯片)

.. image:: media/image2.png
   :align: center
   :alt: image2

图 5‑2 STM32F407IGT6正面引脚图
...
Block0主要用于设计片内的FLASH， F407系列片内部FLASH最大是1MB，我们使用的STM32F407IGT6的FLASH就是1MB。
